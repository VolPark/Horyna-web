<header class="u-clearfix u-header u-header" id="sec-9c1c">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            ...
            'default_url' => "[page_2090142]"
        )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-align-center-xs u-image u-logo u-image-1 custom-logo-link" data-image-width="191" data-image-height="66" title="Úvod">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_style' => 'padding: 0px 5px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-1c55-29',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => '',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-1c55-31',
                    'submenu_item_class' => 'u-nav-item',
