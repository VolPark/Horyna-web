...
if (class_exists('Woocommerce')) {
    function np_filters_by_attribute() {
        // Register custom widget filter by attributes
        if (file_exists(get_template_directory() . '/woocommerce/widgets/custom-widget-filter-by-attribute.php')) {
            require get_template_directory() . '/woocommerce/widgets/custom-widget-filter-by-attribute.php';
            register_widget('NP_Widget_Filter_By_Attribute');
        }
    }
    add_action( 'widgets_init', 'np_filters_by_attribute' );
}