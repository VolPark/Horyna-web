...
?>
<tr style="<?php echo $trStyle; ?>" class="<?php echo $trClass; ?> woocommerce-shipping-totals shipping">
    <th style="<?php echo $td1Style; ?>" class="<?php echo $td1Class; ?>"><?php echo wp_kses_post( $package_name ); ?></th>
    <td style="<?php echo $td2Style; ?>" class="<?php echo $td2Class; ?>" data-title="<?php echo esc_attr( $package_name ); ?>">
