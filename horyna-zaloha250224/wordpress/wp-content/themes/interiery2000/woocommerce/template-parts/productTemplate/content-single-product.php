...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
    <div class="summary">
        <?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-3546">
...
?>
        ...
        <?php if ($product->is_in_stock()) {
                        ob_start(); ?>
            <a class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-product-control u-text-black u-text-hover-white u-btn-1" data-product-button-click-type="go-to-page"><!--product_button_content-->{AddToCartText}<!--/product_button_content--></a>
