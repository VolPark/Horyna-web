<?php global $product; global $cart_custom_template; ?><?php $skip_min_height = false; ?><section class="u-clearfix u-section-1" id="sec-ec32">
    ...
    <div class="u-cart u-cart-1">
      <div class="u-cart-products-table u-table u-table-responsive">
		...
		c0.391-0.391,0.391-1.023,0-1.414L27.414,26l8.293-8.293C36.098,17.316,36.098,16.684,35.707,16.293z"></path>
                ...
                </h2><?php echo wc_get_formatted_cart_item_data( $cart_item ); ?>
              </td>
...
</g></svg></span>&nbsp;<?php esc_html_e( 'Continue shopping', 'woocommerce' ); ?> 
        </a>
              ...
              <div class="u-cart-form u-form">
                <form action="#" method="post" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="custom" name="form">
                  <div class="u-form-group">
                    ...
                    <input type="text" placeholder="<?php echo __( 'Coupon code.', 'woocommerce' ); ?>" id="name-5861" name="coupon" class="u-border-1 u-input u-input-rectangle u-none" required="">
                  </div>
