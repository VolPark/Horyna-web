...
--custom-color-1: #9a1212;
--custom-color-1-darker: #8b1010;
--custom-color-1-r: 154;
--custom-color-1-g: 18;
--custom-color-1-b: 18;
--custom-color-1-contrast: white;
--custom-color-1-contrast-darker: white;
--custom-color-1-text-color: var(--body-alt-color);
--custom-color-2: #ef3f3c;
--custom-color-2-darker: #ed2420;
--custom-color-2-r: 239;
--custom-color-2-g: 63;
--custom-color-2-b: 60;
...
--bg-contrast: var(--body-color);
        ...
        {
            color: var(--custom-color-2) !important;
        }</style><style id="typography" typography="custom-page-typography-7">
        .u-body
        {
        ...
        /** alt-color-rules **/
    </style><style id="font-scheme" font-scheme="custom-font-family-1" heading-font="Montserrat,sans-serif" text-font="Montserrat,sans-serif">.u-body {
